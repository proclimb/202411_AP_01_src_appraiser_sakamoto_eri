			...
			<tr>
				...
				<td>
					...
					?>
						...
						<input type="radio" name="rank" value="<?php print $i + 1; ?>" <?php if ($i + 1 === 1) print ' checked="checked"'; ?> /> <?php print fnRankName($i); ?>
					<?php
					}
					?>
				</td>
			...
			<tr>
				...
				<td>
					...
					?>
						...
						<input type="radio" name="distance" value="<?php print $i + 1; ?>" <?php if ($i + 1 === 1) print ' checked="checked"'; ?> /> <?php print fnDistanceName($i); ?>
					<?php
					}
					?>
				</td>
			...
			<tr>
				...
				<td>
					...
					?>
						...
						<input type="radio" name="how" value="<?php print $i + 1; ?>" <?php if ($i + 1 === 1) print ' checked="checked"'; ?> /> <?php print fnHowName($i); ?>
					<?php
					}
					?>
				</td>
